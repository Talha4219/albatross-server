...
const Header = () => {
  ...
  return (
    <header className="flex h-fit w-full items-center justify-between p-4 lg:h-full lg:max-w-[300px] lg:flex-col lg:items-start lg:justify-start lg:p-0">
      {/* logo */}
      <Link to="/">
        <img src={images.Logo} alt="logo" className="w-[7-px]  mt-[-20px] mb-[-20px] lg:hidden" />
      </Link>
      {/* menu burger icon */}
          ...
          <div className="fixed top-0 bottom-0 left-0 z-50 w-3/4 p-4 overflow-y-auto bg-white lg:static lg:h-full lg:w-full lg:p-6">
            ...
            <div className="mt-6 flex flex-col gap-y-[0.563rem]">
              ...
              >
                ...
                {/* <button disabled={isLoadingCreatePost} className="text-start disabled:opacity-60 disabled:cursor-not-allowed" onClick={ handleCreateNewPost}>Add New Post</button> */}
